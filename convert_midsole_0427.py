"""
HDF5 → LeRobot v3.0 변환 스크립트 (midsole_grasping_0427)
...
# 설정
# ============================================================
HDF5_DIR = "/media/youngwoo/OPR_LINUX/shoes_demo/midsole_grasping_0427"
OUTPUT_DIR = os.path.expanduser("~/midsole_grasping_0427_smolvla")
FPS = 30
ROBOT_TYPE = "openarm"
NUM_WORKERS = 8
...
def main():
    print("=" * 60)
    print("HDF5 → LeRobot v3.0 변환 (midsole_grasping_0427)")
    print("=" * 60)
